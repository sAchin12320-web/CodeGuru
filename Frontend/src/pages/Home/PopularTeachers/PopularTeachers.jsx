            ...
            {instructors ? (
                <div className='grid mb-28 md:grid-cols-2 lg:grid-cols-4 w-[90%] gap-4 mx-auto'>
                    {instructors.map((instructor, i) => (
                        <div
                            key={instructor.id || i} // Ensure a unique key for each item
                        ...
                        >
                            <div className='flex-col flex gap-6 md:gap-8'>
                                <img className='rounded-full border-4 border-gray-300 h-24 w-24' src={instructor?.instructor?.photoUrl || `${img}`} alt="" />
